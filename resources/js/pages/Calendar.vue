<template>
    <Layout>
        <div class="min-h-screen w-full border-t border-gray-300 mt-11 bg-gray-50 flex">
            ...
            <Dialog v-model:visible="dialogVisible" modal :style="{ width: '45rem' }">
                <template #header>
                    <Message Tag icon="pi pi-user" :closable="false" severity="info">
                        <span style="font-weight: 600">{{ selectedReservationDetails?.customerName }}</span>
                    </Message>
                </template>
                ...
                <div class="my-2 grid grid-cols-1">
                    ...
                    <div class="p-1 mt-4 flex items-center border-t border-dashed border-black h-30 justify-center">
                        ...
                        <span>From: {{ formatDate(selectedReservationDetails?.dateStart) }}</span>
                    </div>
                    <div class="p-1 border-b border-dashed border-black h-30 flex items-center justify-center">
                        ...
                        <span>To: {{ formatDate(selectedReservationDetails?.dateEnd) }}</span>
                    </div>
                </div>
            </Dialog>
        </div>
